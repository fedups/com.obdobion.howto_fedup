...
public class CalcTest
{
    ...
    public void castError() throws Exception
    {
        ...
        Assert.assertEquals("20597", context.getOutline().getWriter().toString().trim());
    ...
    public void dateFmtFromEquation() throws Exception
    {
        ...
        Assert.assertEquals("1960-04-09", context.getOutline().getWriter().toString().trim());
    ...
    public void dateFromDirective() throws Exception
    {
         ...
         */
        Assert.assertEquals("70560", context.getOutline().getWriter().toString().trim());
    ...
    public void doubleResult() throws Exception
    {
        ...
        Assert.assertEquals("778.210", context.getOutline().getWriter().toString().trim());
    ...
    public void longResult() throws Exception
    {
        ...
        Assert.assertEquals("20257", context.getOutline().getWriter().toString().trim());
    ...
    public void stringResult() throws Exception
    {
        ...
        Assert.assertEquals("abcxyz", context.getOutline().getWriter().toString().trim());
    ...
    public void timeFmtFromEquation() throws Exception
    {
        ...
        Assert.assertEquals("10:32:00.000", context.getOutline().getWriter().toString().trim());
